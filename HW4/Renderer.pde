...
public class Inspector {
    ...
    public void setGameObject(GameObject go) {
        ...
        for (int i=0; i<position_slider.length; i++) {
            position_slider[i] = new Slider(box.pos.add(new Vector3(40, 30 + i * 20, 0)), new Vector3(box.pos.x + 40, box.pos.x + 150, 0), new Vector3(-50, 50, 0), true);
        }
        ...
        for (int i=0; i<object_color_slider.length; i++) {
            object_color_slider[i] = new Slider(box.pos.add(new Vector3(40, 30 + i * 20 + 300, 0)), new Vector3(box.pos.x + 40, box.pos.x + 150, 0), new Vector3(0, 1, 0), true);
        }
        ...
        for (int i=0; i<scale_slider.length; i++) {
            light_color_slider[i] = new Slider(box.pos.add(new Vector3(40, 30 + i * 20 + 300, 0)), new Vector3(box.pos.x + 40, box.pos.x + 150, 0), new Vector3(0, 1, 0), true);
        }
        ...
        materialButton = new MaterialButton(box.pos.add(new Vector3(40, 30 + 3 * 20 + 350, 0)), new Vector3(120, 40, 0));
    ...
    public void run() {
        ...
        if (gameObject!=null) {
            ...
            if (gameObject.getClass() == GameObject.class) {
                ...
                gameObject.material.albedo = new Vector3(object_color_slider[0].value(), object_color_slider[1].value(), object_color_slider[2].value());
                ...
                basic_light.light_color = new Vector3(light_color_slider[0].value(), light_color_slider[1].value(), light_color_slider[2].value());
            }
        }
    }
}
